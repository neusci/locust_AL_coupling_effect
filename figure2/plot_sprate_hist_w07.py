...
if len(sList)==1:
    savetxt('./data/hist_onNet_c%d.txt'%sList[0], x)
    savetxt('./data/hist_offNet_c%d.txt'%sList[0], y)
else:
...
ylabel('fraction')
if len(sList)==1:
    savefig('hist_onNet_osc_c%d.jpg'%sList[0])
    savefig('hist_onNet_osc_c%d.eps'%sList[0])
else:
...
ylabel('fraction')
if len(sList)==1:
    savefig('hist_offNet_osc_c%d.jpg'%sList[0])
    savefig('hist_offNet_osc_c%d.eps'%sList[0])
else:
...
if len(sList)==1:
    savetxt('./data/hist_onNet_period2_c%d.txt'%sList[0], z)
else:
...
ylabel('fraction')
if len(sList)==1:
    savefig('hist_onNet_period2_c%d.jpg'%sList[0])
    savefig('hist_onNet_period2_c%d.eps'%sList[0])
else:
...
if len(sList)==1:
    savetxt('./data/hist_onNet_period3_c%d.txt'%sList[0], zz)
else:
...
ylabel('fraction')
if len(sList)==1:
    savefig('hist_onNet_period3_c%d.jpg'%sList[0])
    savefig('hist_onNet_period3_c%d.eps'%sList[0])
else:
