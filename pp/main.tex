...
In accordance with experiment~\citep{}, %It is verified in Fig.~\ref{Figure1:model} that,
...
\begin{figure}[htbp]%\ContinuedFloat
  \centering
    ...
    \begin{overpic}[scale=0.2]{figures/fig1/psd_20Hz.eps} \end{overpic}
    \end{minipage} }
    %\hspace{0.5cm}
    \subfigure[bandpower]{\label{Fig1:bandpower}
    \begin{minipage}[h]{0.3\textwidth}
    \begin{overpic}[scale=0.2]{figures/fig1/bandpower.eps} \end{overpic}
    \end{minipage} }
  %\vspace{-15mm}
    \subfigure[raster plot]{\label{Fig1:slowraster}
    \begin{minipage}[h]{0.3\textwidth}
    \begin{overpic}[scale=0.2]{figures/fig1/v_short_line_12.eps} \end{overpic}
    \end{minipage} }
    %\hspace{0.5cm}
  \vspace{-5mm}

    \subfigure[3 PNs' firing rate]{\label{Fig1:slowfirerate}
    \begin{minipage}[h]{0.3\textwidth}
    \begin{overpic}[scale=0.2]{figures/fig1/firerate_of_a_neuron_curves.eps} \end{overpic}
    \end{minipage} }
  %\vspace{-15mm}
    \subfigure[firing rate]{\label{Fig1:firerate}
    \begin{minipage}[h]{0.3\textwidth}
    \begin{overpic}[scale=0.2]{figures/fig1/fire_rate.eps} \end{overpic}
    \end{minipage} }
    %\hspace{0.5cm}
    \subfigure[response rate]{\label{Fig1:response}
    \begin{minipage}[h]{0.3\textwidth}
    \begin{overpic}[scale=0.2]{figures/fig1/response.eps} \end{overpic}
    \end{minipage} }
  \vspace{-5mm}
