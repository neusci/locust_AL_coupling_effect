...
\begin{figure}[htbp]\centering
    ...
    (a) Peak-normalized peri-stimulus time histograms (PSTHs), averaged across all odors and all PNs. Odor stimulation begins at 0 ms. (b) Comparison of PN responses peaking time in the two modes, PNs in the {\bf R} mode has a shorter latency to reach the peak than in the {\bf S} mode. ({\bf need tobe revised})
    }
\end{figure}
...
\begin{figure}[htbp]\centering
    ...
    \end{minipage} }
    \hspace{0.5cm}
    \subfigure[{\bf R} - osc]{\label{Fig2:onnetosc}
    \begin{minipage}[h]{0.4\textwidth}
